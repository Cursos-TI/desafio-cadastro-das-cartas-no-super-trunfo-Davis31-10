...
int main (){
    ...
    float area1,densidade1,pibpercapita1,pib1;
    char estado1, codigocarta1[5], cidade1[25];
    
    int populacao2, pturisticos2;
    float area2,densidade2,pibpercapita2,pib2;
    ...
    pibpercapita1 =  (float) 1000000000 * pib1;
    pibpercapita1 /= (float) populacao1;

    pibpercapita2 =  (float) 1000000000 * pib2;
    pibpercapita2 /= (float) populacao2;


    // Impressão dos dados das cartas1  com adição da densidade e pibpercapta
    printf("Carta 1:\n");
    printf("Estado: %c\n", estado1);
    printf("Código: %s\n", codigocarta1);
    ...
    // Impressão dos dados das cartas2 com adição da densidade e pibpercapta
    printf("Carta 2:\n");
    printf("Estado: %c\n", estado2);
    printf("Código: %s\n", codigocarta2);
    printf("Nome da Cidade: %s\n",cidade2);
